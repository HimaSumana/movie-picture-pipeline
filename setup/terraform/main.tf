...
# EKS Node Group
##################
# Track latest release for the given k8s version (AWS picks default recommended AMI automatically)
...
# In voclabs, user policies are attached via console or pre-configured roles
